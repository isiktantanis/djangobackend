# Generated by Django 4.0.4 on 2022-07-16 12:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profilePicture', models.ImageField(default='profilePictures/default.png', storage=Web.models.OverwriteStorage(), upload_to=Web.models.FileUploadLocation(fields=['username'], parentFolder='profilePictures/'), verbose_name='Profile Picture')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backgroundPicture', models.ImageField(storage=Web.models.OverwriteStorage(), upload_to=Web.models.FileUploadLocation(fields=['name', 'background'], parentFolder='Categories/'), verbose_name='Background Picture')),
                ('foregroundPicture', models.ImageField(storage=Web.models.OverwriteStorage(), upload_to=Web.models.FileUploadLocation(fields=['name', 'foreground'], parentFolder='Categories/'), verbose_name='Foreground Picture')),
                ('lft', models.PositiveIntegerField(editable=False)),
                ('rght', models.PositiveIntegerField(editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collectionImage', models.ImageField(storage=Web.models.OverwriteStorage(), upload_to=Web.models.FileUploadLocation(fields=['name'], parentFolder='NFTCollections/'), verbose_name='Collection Image')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('lft', models.PositiveIntegerField(editable=False)),
                ('rght', models.PositiveIntegerField(editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
