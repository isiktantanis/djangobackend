# Generated by Django 4.0.4 on 2022-05-03 19:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='NFT',
            fields=[
                ('uid', models.TextField(primary_key=True, serialize=False, verbose_name='Unique ID')),
                ('nID', models.IntegerField(verbose_name='ID')),
        ...
        migrations.AddField(
            model_name='nftcollection',
            name='owner',
            field=models.ForeignKey(on_delete=models.SET('USER_DELETED'), related_name='owner', to=settings.AUTH_USER_MODEL, to_field='username', verbose_name='Name'),
        ),
        migrations.AddField(
            model_name='nftcollection',
            name='parent',
