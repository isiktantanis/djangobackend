            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        storage=Web.models.OverwriteStorage(),
                        upload_to="nfts/",
                        verbose_name="File",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "uAddress",
                    models.TextField(
                        primary_key=True, serialize=False, verbose_name="Address"
                    ),
                ),
                (
                    "username",
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        null=True,
                        storage=Web.models.OverwriteStorage(),
                        upload_to=Web.models.FileUploadLocation(
                            fields=["username"], parentFolder="profilePictures/"
                        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        storage=Web.models.OverwriteStorage(),
                        upload_to="",
                        verbose_name="Foreground Picture",
                    ),
                ),
                ("lft", models.PositiveIntegerField(editable=False)),
                ("rght", models.PositiveIntegerField(editable=False)),
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        storage=Web.models.OverwriteStorage(),
                        upload_to=Web.models.FileUploadLocation(
                            fields=["name"], parentFolder="NFTCollections/"
                        ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="Web.nftcollectioncategory",
                        verbose_name="Category of the NFT Collection.",
                    ),
                ),
                (
                    "owner",
            ...
            fields=[
                ...
                (
                    ...
                    mptt.fields.TreeForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="children",
                        to="Web.userwatchlistednftcollection",
                    ),
                ),
                (
                    "user",
