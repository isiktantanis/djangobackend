# Generated by Django 4.0.4 on 2022-07-15 11:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('totalNFTLikes', models.IntegerField(default=0, verbose_name='Number of liked NFTs')),
                ('totalCollectionLikes', models.IntegerField(default=0, verbose_name='Number of liked NFT Collections')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('numLikes', models.IntegerField(default=0, verbose_name='Number of Likes')),
                ('totalNFTLikes', models.IntegerField(default=0, verbose_name="Total Number of Likes of all NFT's inside the Collection")),
                ('lft', models.PositiveIntegerField(editable=False)),
                ('rght', models.PositiveIntegerField(editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ...
                ('owner', models.ForeignKey(on_delete=models.SET('USER_DELETED'), related_name='NFTCollection', to=settings.AUTH_USER_MODEL, to_field='username', verbose_name='Owner')),
        ...
        migrations.AddField(
            model_name='nft',
            name='address',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='Web.nftcollection', verbose_name='Collection Address'),
        ),
        migrations.AddField(
            model_name='nft',
            name='collectionName',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='Web.nftcollection', to_field='name', verbose_name='Collection Name'),
        ),
        migrations.AddField(
            model_name='nft',
            name='creator',
