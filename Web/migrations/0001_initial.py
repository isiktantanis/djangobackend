    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='Web.nftcollection')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('collectionName', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Web.nftcollection', verbose_name='Collection Name')),
                ('creator', models.ForeignKey(on_delete=models.SET('USER_DELETED'), related_name='creator', to=settings.AUTH_USER_MODEL, verbose_name='Creator')),
                ('currentOwner', models.ForeignKey(on_delete=models.SET('USER_DELETED'), to=settings.AUTH_USER_MODEL, verbose_name='Current Owner')),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='Web.nft')),
            ],
            options={
